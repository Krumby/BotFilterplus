package ru.krumby.bfplus.caching;
...
import ru.krumby.bfplus.packets.DefaultSpawnPosition;
import ru.krumby.bfplus.packets.EmptyChunkPacket;
import ru.krumby.bfplus.packets.JoinGame;
import ru.krumby.bfplus.packets.PlayerAbilities;
import ru.krumby.bfplus.packets.PlayerPositionAndLook;
import ru.krumby.bfplus.packets.SetExp;
import ru.krumby.bfplus.packets.SetSlot;
import ru.krumby.bfplus.packets.TimeUpdate;
import ru.krumby.bfplus.utils.Dimension;
...
public class PacketUtils
{
    ...
    public static void init()
    {
        ...
        DefinedPacket[] packets =
        {
            ...
            new SetSlot( 0, Settings.CAPTCHA.SLOT, 358, 1, 0 ), //5 map 1.8+
            new SetSlot( 0, Settings.CAPTCHA.SLOT, -1, 0, 0 ), //6 map reset
    ...
    private static DefinedPacket createPluginMessage()
    {
        ...
        DefinedPacket.writeString( "BotFilterPlus (dsc.gg/bfplus)", brand );
