...
public class BFPRippler
{
    ...
    public static class AxisConfig
    {
        ...
        {
            this.start = normalize( start, Settings.CAPTCHA.RIPPLE);
            this.length = normalize( length, Settings.CAPTCHA.RIPPLE);
     ...
     */
    public BFPRippler(AxisConfig vertical, AxisConfig horizontal)
    {
